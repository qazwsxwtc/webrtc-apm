...
// Forward declarations for video types (originally from api/video/)
enum class VideoRotation { kRotation0, kRotation90, kRotation180, kRotation270 };
enum class VideoContentType { kUnspecified, kScreenshare };
